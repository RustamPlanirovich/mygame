...
• 🟢 +10% за соседнюю электростанцию (радиус 2, макс 3)
• 🟢 +15% от Хранилища энергии рядом (радиус 2, макс 2)

Топливная электростанция:
• 🟢 +10% за соседнюю электростанцию (радиус 2, макс 3)

Солнечная панель:
• 🔴 -10% за производственное здание рядом (радиус 1, макс 4)

Хранилище энергии:
• 🟢 +20% при 2+ электростанциях рядом (радиус 2)

══════════════════════════════════════
⛏️ ДОБЫВАЮЩИЕ ЗДАНИЯ
══════════════════════════════════════

Рудный экстрактор, Ледяной комбайн, Углеродный сборщик, Газовая скважина, Нефтяная скважина:
• 🟢 +50% от Ускорителя ресурсов рядом (радиус 3)
• 🟢 +15% от Логистического центра рядом (радиус 3)
...
Литейный завод:
• 🟢 +15% за Рудный экстрактор рядом (радиус 3, макс 2)
• 🟢 +25% от Системы охлаждения (радиус 2)

Химический завод:
• 🟢 +10% за производственное здание рядом (радиус 2, макс 3)
• 🚫 Нельзя строить рядом с исследовательскими (радиус 3)

Завод полупроводников:
• ⚠️ ТРЕБУЕТСЯ Система охлаждения в радиусе 2!
• 🟢 +30% за Систему охлаждения рядом (макс 2)
...
Ускоритель ресурсов:
• 🟢 +20% при 3+ шахтах в радиусе 3

Склад:
• 🟢 +10% за производственное здание (радиус 3, макс 5)

Логистический центр:
• 🟢 +15% добычи/производства (радиус 4, макс 5)

Биткоин-ферма:
• ⚠️ ТРЕБУЕТСЯ Атомная электростанция в радиусе 4!
• 🟢 +40% за Систему охлаждения (радиус 2, макс 3)

Система охлаждения:
• 🟢 +15% при 2+ производственных зданий (радиус 2)
...
Турель:
• 🟢 +25% урона от Радарного завода (радиус 3, макс 2)
• 🟢 +10% урона за Турель рядом (радиус 2, макс 3)
...
Ракетный завод:
• 🟢 +15% за космическое здание (радиус 2, макс 4)

Завод космических кораблей:
• 🟢 +20% за космическое здание (радиус 2, макс 4)

Космическая колония:
• 🟢 +25% при 3+ космических зданий (радиус 3)

══════════════════════════════════════
📋 ЛЕГЕНДА
══════════════════════════════════════

🟢 Бонус - увеличивает производство
🔴 Штраф - уменьшает производство  
⚠️ Требуется - здание должно быть рядом
🚫 Несовместимо - нельзя размещать рядом

Предупреждения при размещении:
...
Необходимы для некоторых концовок игры!`,
  },
  {
    ...
    category: 'Бой',
    content: `Ваша база постоянно под угрозой атаки!

══════════════════════════════════════
⚔️ ВОЛНЫ АТАК
══════════════════════════════════════

Каждые 60 секунд начинается новая волна врагов:
• Волна длится 18 секунд
• Враги появляются каждые 1.8 секунды
• Максимум 40 врагов за волну

Статусы в заголовке:
• ТИШИНА — нет врагов, таймер до следующей волны
• АТАКА — активная волна, таймер до конца
• ОФФЛАЙН — база уничтожена (HP = 0)
...
Разведчик (Scout) 🔍
• HP: 18 · DPS: 0.9 · Скорость: высокая
• Быстрый, но не очень опасный

Роевик (Swarmer) ⚡
• HP: 12 · DPS: 0.6 · Скорость: средняя
• Давит числом, раньше входит в контакт

Громила (Brute) 🛡️
• HP: 34 · DPS: 1.6 · Скорость: низкая
• Опасный! 30% урона проходит СКВОЗЬ щит!

══════════════════════════════════════
🎯 МЕХАНИКА УРОНА
══════════════════════════════════════

Враги движутся к базе (distance 100% → 0%):
• При приближении начинают наносить урон
• При distance = 0% — ИМПАКТ (12 урона за врага)
• Сначала урон поглощает щит
• Затем урон идёт по HP базы

Давление (Pressure):
• Показывает текущий урон/сек от всех врагов
• Зависит от количества и дистанции врагов
...
В списке врагов:
• Полоса = оставшееся HP врага (100% = полное)
• 🎯 X% = дистанция до базы (0% = контакт)
• Мигание = враг почти уничтожен

Почему полоса полная при низком %?
Это разные показатели! Полоса — HP, % — дистанция.`,
  },
  {
    id: 'defense',
    title: 'Оборона базы',
    category: 'Бой',
    content: `Защитите базу от врагов!

══════════════════════════════════════
🛡️ ЩИТОВОЙ ГЕНЕРАТОР (Shield Mk1)
══════════════════════════════════════

Постройте shield_mk1 для защиты:
• Добавляет HP щита к базе
• Щит поглощает урон раньше HP базы
• Требует энергию для регенерации
• Регенерация активна только во время атаки

Без щита все урон идёт напрямую по базе!

══════════════════════════════════════
🔫 ТУРЕЛИ (Turret Mk1)
══════════════════════════════════════

Постройте turret_mk1 для уничтожения врагов:
• Наносят урон врагам автоматически
• Требуют энергию для стрельбы
• Эффективность падает при нехватке ⚡
• Размещайте рядом для бонусов (+10%)

Показатели:
• Оборона: X⚡/Y⚡ — энергия используемая/нужная
• (XX%) — эффективность огня

══════════════════════════════════════
⚡ ЭНЕРГИЯ В БОЮ
══════════════════════════════════════

Во время атаки расходуется много энергии:
• Турели — для стрельбы
• Щиты — для регенерации

При дефиците энергии:
• Эффективность турелей падает
• Регенерация щитов замедляется
• Планируйте энергозапас!`,
  },
  {
    id: 'basehp',
    title: 'HP базы и последствия',
    category: 'Бой',
    content: `❤️ HP базы — ваша главная защита!
...
База имеет 100 HP:
• Зелёная полоса = HP выше 50%
• Жёлтая полоса = HP 25-50%
• Красная мигающая = HP ниже 25% (ОПАСНО!)

Цвет надписи "База" также меняется:
• Синий — всё в порядке
• Жёлтый — повреждения
• Красный + ⚠️ — критическое состояние

══════════════════════════════════════
⚠️ ШТРАФ ПРОИЗВОДСТВА
══════════════════════════════════════

Повреждённая база работает хуже!

Штраф зависит от потерянного HP:
• 100% HP → без штрафа
• 75% HP → -12.5% производство
• 50% HP → -25% производство
• 25% HP → -37.5% производство
• 0% HP → -50% производство (максимум)

Формула: штраф = (1 - HP%) × 50%

══════════════════════════════════════
🔧 РЕГЕНЕРАЦИЯ
══════════════════════════════════════

База восстанавливает HP автоматически:
• Скорость: +0.5 HP/сек
• Условия:
  - Нет врагов на поле
  - Волна не активна
  - Прошло 5 секунд с последнего урона

При активной атаке регенерация НЕ работает!

══════════════════════════════════════
🆘 ЭКСТРЕННЫЙ РЕМОНТ
══════════════════════════════════════

Кнопка появляется когда база повреждена:
• Стоимость: 500⚡ + 50 стали
• Восстанавливает: +50 HP
• Можно использовать многократно

Используйте во время боя, когда регенерация
недоступна, а база в критическом состоянии!

══════════════════════════════════════
💀 ЧТО ПРОИСХОДИТ ПРИ HP = 0?
══════════════════════════════════════

• Статус меняется на "ОФФЛАЙН"
• Новые волны НЕ начинаются
• Враги исчезают
• Производство снижено на 50%
• Оборона не работает

Как восстановить:
1. Подождите регенерацию (после паузы)
2. Используйте экстренный ремонт
3. Престиж полностью восстанавливает базу`,
  },
  {
    id: 'nanoswarm',
    title: 'Нано-Рой',
    category: 'Бой',
    content: `🦠 Ваша армия микроботов!

══════════════════════════════════════
📦 ЧТО ТАКОЕ НАНО-РОЙ?
══════════════════════════════════════

У вас есть 100 наноботов (пул), которые можно
распределить между тремя задачами:

• 🔴 Атака — боты атакуют врагов
• 🟢 Ремонт — боты чинят щит базы
• 🔵 Буст — боты ускоряют производство

Нано-рой работает БЕСПЛАТНО (без энергии)!

══════════════════════════════════════
🔴 АТАКА
══════════════════════════════════════

Каждый бот наносит 0.05 DPS
• При 33% (33 бота) = 1.65 DPS
• При 100% (100 ботов) = 5 DPS

Боты атакуют автоматически даже без турелей!
Это ваша первичная защита в начале игры.

══════════════════════════════════════
🟢 РЕМОНТ
══════════════════════════════════════

Каждый бот восстанавливает 0.08 HP/сек щита
• При 33% = 2.64 HP/сек
• При 100% = 8 HP/сек

Работает только если есть щитовой генератор!
Ремонт дополняет энергетическую регенерацию.

══════════════════════════════════════
🔵 БУСТ
══════════════════════════════════════

Ускоряет ВСЁ производство зданий:
• При 100% буст = +50% к производству
• При 50% буст = +25%
• При 0% = без бонуса

Используйте буст вне боя для экономики!

══════════════════════════════════════
💡 ТАКТИЧЕСКИЕ СОВЕТЫ
══════════════════════════════════════

• Во время боя: 60% атака + 40% ремонт
• Вне боя: 100% буст для производства
• Нет щита? 100% атака для защиты`,
  },
  {
    id: 'aegis',
    title: 'Протокол Эгида',
    category: 'Бой',
    content: `🛡️ Улучшения боевых систем!

══════════════════════════════════════
📋 ЧТО ТАКОЕ ЭГИДА?
══════════════════════════════════════

Протокол Эгида — дерево боевых улучшений.
Покупаются за энергию и сталь.

══════════════════════════════════════
🎯 SMART TARGETING
══════════════════════════════════════

Уровней: 1 (разовая покупка)
Стоимость: 420⚡ + 18 стали

Эффект:
Турели и нано-рой фокусируют врага
с МАКСИМАЛЬНЫМ HP (не самого ближнего).

Зачем?
• Меньше оверкилла (потерянного урона)
• Быстрее убивает опасных врагов (Громил)
• Эффективнее расходует энергию

Статус: ✓ = активен, × = не куплен
...
Уровней: 10
Стоимость: 360⚡ + 16 стали (×1.55 за уровень)

Эффект:
Снижает ИНТЕРФЕРЕНЦИЮ во время атаки.

Что такое интерференция?
Во время волны атаки ВСЁ производство
замедляется! (враги мешают работе)

• Каждый враг = -2% производство
• Максимум замедление = -50%

Encryption снижает этот штраф:
• Уровень 1 = -6% от штрафа
• Уровень 10 = -60% от штрафа

Показатель "Интерф.: -X% → -Y%":
• X% = базовое замедление
• Y% = после Encryption
...
1. Smart Targeting — один раз, но очень полезно
2. Encryption — прокачивайте постепенно,
   когда интерференция мешает экономике`,
  },
];
