...
export function createRealtimeHub() {
  ...
  return {
    ...
    /**
     * Подключён ли игрок прямо сейчас.
     *
     * Нужно админке (bigplan.md, пункт 9): выдачу ресурсов онлайн-игроку можно применить
     * безопасно ТОЛЬКО если ему есть куда её дослать. Иначе его автосохранение перезапишет
     * патч в БД, и выдача исчезнет.
     */
    hasUser(userId) {
